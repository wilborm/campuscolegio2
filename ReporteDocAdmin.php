...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/stylesheet1_ReporteDocAdmin.css">
        <link rel="stylesheet" href="css/estilos_ReporteDocAdmin.css">
            ...
            <div class="contenido">
                ...
                <div>
                    <table class="table table-hover">
						...
						<tr>
							<td><?php echo $row['doc_nombre'];?>
							</td>
							<td>
								<?php echo $row['doc_apaterno'];?>
							</td>
							<td>
								<?php echo $row['doc_genero'];?>
							</td>
							<td>
								<?php echo $row['doc_email'];?>
							</td>
							<td>
								<?php echo $row['doc_identificador'];?>
							</td>
						</tr>
					<?php } ?>
                        </tbody>
