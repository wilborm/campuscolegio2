                                    ...
                                    <div class="bandejae">
                                      <div class="mensaje">
                                        ...
                                        $conexion = mysqli_connect("us-cdbr-iron-east-05.cleardb.net","b01428dfddeb72","83b7f36b","heroku_f3221ea739bdd1f");
                                          $sql = "SELECT * FROM mensaje WHERE de='".$_SESSION['username']."'";
                                        ...
                                        while($row = mysqli_fetch_assoc($res)){ ?>
                                          <tr bgcolor="<?php if($row['leido'] == "si") { echo "#FFE8E8"; } else { if($i%2==0) { echo "#FFE7CE"; } else { echo "#FFCAB0"; } } ?>">
                                            ...
                                            <td align="center" valign="top"><a href="LeerMensajesEnviadosAlum.php?id=<?=$row['ID']?>"><?=$row['asunto']?></a></td>
                                            <td align="center" valign="top"><?=$row['para']?></td>
