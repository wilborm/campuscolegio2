                ...
                <article>
                    ...
                    <div class="content">
                      ...
                      <div class="cont-izq">
                          <div class="cont-izq-up">
                            ...
                            <a href="BandejaEntradaAlum.php" style="color:#fff"><div class="opc">  Bandeja de Entrada</div></a>
                             ...
                             <a href="ValidaDocAlumMensaje.php" style="color:#fff"> <div class="opc">Nuevo</div></a>
                      ...
                      <div class="cont-der">
                        <div class="bandejae">
                          <div class="mensaje">
                            <div class ="remitente"><h3>Seleccione Remitente</h3></div>
                            <br>
                            <br>
                            <a href="php/filtroMensajeDoc.php" style="color:#fff"><h4>Docente</h4></a>
                            <a href="php/filtroMensajeAlum.php" style="color:#fff"><h4>Compañero de Clase</h4></a>
                          </div>
                        </div>
                      </div>
                    </div>  
